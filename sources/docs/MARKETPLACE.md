...
- **I miei item** starts from the Content grid. Opening a Content defaults to three explicit tabs: **Marketplace** lists public Items by other authors that the user has not bought yet (price, details and purchase action); **My Items** contains authored Items with create/edit/delete controls; **Purchased Items** contains prior purchases. A successful Marketplace purchase moves the Item out of the first set and opens Purchased Items immediately. Content cards deliberately have no hover movement animation.
