...
- `user_profile` combines identity and wallet recharge with created visits and saved/favourite visits. Saved visits can be removed from favourites with the star icon beside the row; visit authoring still lives in **Le mie visite**, and Item authoring still lives in **I miei item**.
